...
1. Create or update spec files in `specs/` first
2. Ask clarifying questions to fill in requirements and testing details
3. Update `specs/README.md` with the new entries
4. Only implement after the spec is agreed upon
